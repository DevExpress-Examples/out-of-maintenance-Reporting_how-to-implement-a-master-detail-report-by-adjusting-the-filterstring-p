...
Namespace MasterDetailFilterString.DataSet1TableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        Orders.*" & Constants.vbCrLf & "FROM            Orders"
	...
	Partial Public Class Order_DetailsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        [Order Details].*" & Constants.vbCrLf & "FROM            [Order Details]"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
